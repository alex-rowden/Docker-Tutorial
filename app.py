'''Main file for the application. Building a simple Flask application'''
...
# This appears very similar to the sintax of FastAPI. I should look into why later.
@app.route("/")
def index():
